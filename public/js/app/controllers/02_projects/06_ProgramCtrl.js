define(['angular'], function (angular) {
    ...
    programCtrlModule.controller('animatorCtrl', animatorCtrl);
    ...
    function programMainCtrl($scope, $log, $timeout,toastr, ResourceService) {
        ...
        function updateTotalValues() {
            ...
            $scope.total.planUsd =
                wed[$scope.conf.views[0]].total.planUsd
                + wed[$scope.conf.views[1]].total.planUsd
                + wed[$scope.conf.views[2]].total.planUsd
                + wed[$scope.conf.views[3]].total.planUsd;

            $scope.total.planNat =
                wed[$scope.conf.views[0]].total.planNat
                + wed[$scope.conf.views[1]].total.planNat
                + wed[$scope.conf.views[2]].total.planNat
                + wed[$scope.conf.views[3]].total.planNat;

            // Total Paid calculations
            $scope.total.paidTotalUsd =
                wed[$scope.conf.views[0]].total.paidTotalUsd
                + wed[$scope.conf.views[1]].total.paidTotalUsd
                + wed[$scope.conf.views[2]].total.paidTotalUsd
                + wed[$scope.conf.views[3]].total.paidTotalUsd;

            $scope.total.paidTotalNat =
                wed[$scope.conf.views[0]].total.paidTotalNat
                + wed[$scope.conf.views[1]].total.paidTotalNat
                + wed[$scope.conf.views[2]].total.paidTotalNat
                + wed[$scope.conf.views[3]].total.paidTotalNat;
     ...
     * ANIMATOR CTRL
     * */
    function animatorCtrl($scope, $log, toastr, ResourceService) {
        // INPUT DATA CONFIG
        $scope.conf = {
            // Main setup
            mainProp : 'animator',
