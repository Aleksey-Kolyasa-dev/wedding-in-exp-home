define(['angular'], function (angular) {
    "use strict";
    var registrationCtrlModule = angular.module('registrationCtrlModule', ['wedServices']);

    registrationCtrlModule.controller('registrationMainCtrl', registrationMainCtrl);
  

    /*
     * registration CTRL
     * */
    function registrationMainCtrl($scope, $log, toastr, ResourceService) {
    
        // INPUT DATA CONFIG
        $scope.conf = {
            // Main setup
            mainProp : 'registration',
            parent : 'registration',

            // MSGs setup
            msgNameBg : 'REGISTRATION',
            msgNameSm : 'Registration',
