define(['angular'], function (angular) {
    ...
    * DRESS MAIN CTRL
    * */
    function dressMainCtrl($scope, $log, toastr, ResourceService) {
        // INPUT DATA CONFIG
        $scope.conf = {
            // Main setup
            mainProp : 'dress',
/*
        ...
        function updateTotalValues() {
            ...
            $scope.total.planUsd = wed.dressM.planUsd + wed.dressW.planUsd;
            $scope.total.planNat = wed.dressM.planNat + wed.dressW.planNat;

            // Total Paid calculations
            $scope.total.paidTotalUsd = wed.dressM.paidTotalUsd + wed.dressW.paidTotalUsd;
            $scope.total.paidTotalNat = wed.dressM.paidTotalNat + wed.dressW.paidTotalNat;
            ...
            $log.log($scope.currentProject[$scope.conf.mainProp]);
        }
        updateTotalValues();
