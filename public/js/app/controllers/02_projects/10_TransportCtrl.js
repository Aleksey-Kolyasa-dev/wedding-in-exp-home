define(['angular'], function (angular) {
    "use strict";
    var transportCtrlModule = angular.module('transportCtrlModule', ['wedServices']);

    transportCtrlModule.controller('transportMainCtrl', transportMainCtrl);


    /*
     * transport CTRL
     * */
    function transportMainCtrl($scope, $log, toastr, ResourceService) {
