define(['angular'], function (angular) {
    "use strict";
    var partyCtrlModule = angular.module('partyCtrlModule', ['wedServices']);

    partyCtrlModule.controller('partyMainCtrl', partyMainCtrl);
    partyCtrlModule.controller('partyMCtrl', partyMCtrl);
    partyCtrlModule.controller('partyWCtrl', partyWCtrl);

    /*
     * party MAIN CTRL
     * */
    function partyMainCtrl($scope, $log, $timeout,toastr, ResourceService) {
        // INPUT DATA CONFIG
        $scope.conf = {
            // Main setup
            mainProp : 'party',
     ...
     * partyM CTRL
     * */
    function partyMCtrl($scope, $log, toastr, ResourceService) {
        // INPUT DATA CONFIG
        $scope.conf = {
            // Main setup
            mainProp : 'partyM',
     ...
     * partyW CTRL
     * */
    function partyWCtrl($scope, $log, toastr, ResourceService) {
        // INPUT DATA CONFIG
        $scope.conf = {
            // Main setup
            mainProp : 'partyW',
