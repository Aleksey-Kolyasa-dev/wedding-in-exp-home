define(['angular'], function (angular) {
     ...
     * USERS MAIN CTRL
     * */
    function wedUsersMainCtrl($scope, $rootScope,$http ,$interval ,$log, $window, $location, $timeout, toastr, UsersResourceService, AppService) {
    ...
    function loginCtrl($scope, $window, $log, $location, $timeout, toastr, UsersResourceService, ResourceService, UserAuthService) {
        ...
        if ($window.localStorage.userToken) {
            ...
            // If less then 48 hrs since last login
            if (Date.now() - new Date(token.init) < 1000 * 60 * 60 *48) {
