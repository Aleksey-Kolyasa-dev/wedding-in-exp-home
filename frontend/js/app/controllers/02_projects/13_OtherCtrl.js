define(['angular'], function (angular) {
    "use strict";
    var otherCtrlModule = angular.module('otherCtrlModule', ['wedServices']);

    otherCtrlModule.controller('otherMainCtrl', otherMainCtrl);


    /*
     * other CTRL
     * */
    function otherMainCtrl($scope, $log, toastr, ResourceService) {
